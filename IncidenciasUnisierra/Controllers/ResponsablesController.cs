...
namespace IncidenciasUnisierra.Controllers
{
    public class ResponsablesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IdResponsable,Nombre,Apellidos")] Responsable responsable)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IdResponsable,Nombre,Apellidos")] Responsable responsable)
        {
            if (ModelState.IsValid)
            {
